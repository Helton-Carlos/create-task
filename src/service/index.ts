...
export function makeServer({ environment = "test" } = {}) {
  let server = createServer({
    ...
    routes() {
      ...
      this.get("cards", () => ({
        task: [
          { id: 1, title: "Task", subtitle: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Quae dolores deserunt ea doloremque natus error, rerum quas odio quaerat nam ex commodi hic, suscipit in a veritatis pariatur minus consequuntur!" },
          { id: 2, title: "Late conversations ", subtitle: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Quae dolores deserunt ea doloremque natus error, rerum quas odio quaerat nam ex commodi hic, suscipit in a veritatis pariatur minus consequuntur!" },
        ],
      }))
    },
  })
